...
export const createProductHelper = async (req: Request, res: Response) => {
    try {
...
export const getProductHelper = async (req: Request, res: Response) => {
    try {
...
export const replaceProductHelper = async (req : Request, res: Response) => {
    try {
...
export const modifyProductHelper = async (req: Request, res: Response) => {
    try {
        const params = getPathParams(req);
        const body = getBody(req);
        if (body._id !== undefined) {
...
export const deleteProductHelper = async (req: Request, res: Response) => {
    try {
        const params = getPathParams(req);
        if(params.id === undefined){
            res.writeHead(400, { "Content-Type": "application/json" });
